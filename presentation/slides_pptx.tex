...
\begin{frame}{Feature Impact on Performance}
    \begin{center}
        \begin{tabular}{lcc}
            \toprule
            \textbf{Features} & \textbf{DQN Avg} & \textbf{PPO Avg} \\
            \midrule
            Basic (10-dim) & 25-30 & 28-32 \\
            Flood-Fill (13-dim) & 35-40 & 37-42 \\
            \bottomrule
        \end{tabular}
    \end{center}
    ...
    \textbf{Key insight:}
    \begin{itemize}
        \item Flood-fill features give +10-15 score improvement
...
%-----------------------------------------------
\begin{frame}{Training Setup: GPU Acceleration}
    \textbf{Vectorized Environments:}
    \begin{itemize}
        \item Run 256 snakes in parallel
        \item All on GPU (PyTorch CUDA)
        \item 100-300x speedup vs CPU
    \end{itemize}

    \vspace{0.5cm}
    \textbf{Training time:}
    \begin{itemize}
        \item $\sim$6-7 minutes for 10K episodes
        \item Compared to hours on CPU
    \end{itemize}
...
\begin{frame}{Curriculum Learning Stages}
    ...
    \vspace{0.3cm}
    \begin{enumerate}
        \item \textbf{Stage 0:} vs Static agent (learn basic movement)
        \item \textbf{Stage 1:} vs Random agent (handle unpredictability)
        \item \textbf{Stage 2:} vs Greedy food agent (compete for food)
        \item \textbf{Stage 3:} vs Frozen policy (beat earlier self)
        \item \textbf{Stage 4:} Co-evolution (both agents learning)
    \end{enumerate}
...
\begin{frame}{Two-Snake Results}
    ...
    \vspace{0.5cm}
    \textbf{Win rates vs different opponents:}
    \begin{center}
        \begin{tabular}{lc}
            \toprule
            ...
            Random & 95\%+ \\
            Greedy & 70-80\% \\
            Self-play & 50\% (balanced) \\
            Big Brain vs Small Brain & 60-30 \\
            \bottomrule
        \end{tabular}
    \end{center}
\end{frame}
