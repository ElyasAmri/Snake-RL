"""
Train REINFORCE with MLP (Feature-based State)

Standalone script for training REINFORCE with 11-dimensional feature state representation.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train REINFORCE-MLP on Snake game')
    ...
    parser.add_argument('--save-path', type=str, default='results/weights/reinforce_mlp_128x128.pt', help='Path to save weights')

    args = parser.parse_args()

    print('='*70)
    print('Training REINFORCE-MLP (Feature-based State)')
    print('='*70)
