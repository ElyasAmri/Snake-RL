"""
Train Dueling DQN with MLP (Feature-based State)

Standalone script for training Dueling DQN with 11-dimensional feature state representation.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train Dueling DQN-MLP on Snake game')
    ...
    parser.add_argument('--save-path', type=str, default='results/weights/dueling_dqn_mlp_128x128.pt', help='Path to save weights')

    args = parser.parse_args()

    print('='*70)
    print('Training Dueling DQN-MLP (Feature-based State)')
    print('='*70)
