"""
Train PPO with MLP and Flood-Fill Features

Standalone script for training PPO with 14-dimensional feature state representation including flood-fill.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train PPO-MLP with Flood-Fill on Snake game')
    ...
    parser.add_argument('--epochs-per-rollout', type=int, default=10, help='Epochs per rollout')
    ...
    parser.add_argument('--save-path', type=str, default='results/weights/ppo_mlp_floodfill_128x128.pt', help='Path to save weights')

    args = parser.parse_args()

    print('='*70)
    print('Training PPO-MLP with Flood-Fill (14-feature State)')
    print('='*70)
