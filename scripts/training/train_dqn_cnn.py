"""
Train DQN with CNN (Grid-based State)

Standalone script for training DQN with 10x10x3 grid state representation.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train DQN-CNN on Snake game')
    ...
    parser.add_argument('--save-path', type=str, default='results/weights/dqn_cnn.pt', help='Path to save weights')

    args = parser.parse_args()

    print('='*70)
    print('Training DQN-CNN (Grid-based State)')
    print('='*70)
