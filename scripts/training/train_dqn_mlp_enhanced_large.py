"""
Train DQN with MLP and Enhanced Features (Large Network)

Standalone script for training DQN with 24-dimensional feature state representation including all enhanced features and larger network.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train DQN-MLP with Enhanced Features (Large) on Snake game')
    ...
    parser.add_argument('--save-path', type=str, default='results/weights/dqn_mlp_enhanced_large_256x256.pt', help='Path to save weights')

    args = parser.parse_args()

    print('='*70)
    print('Training DQN-MLP with Enhanced Features (24-feature State, Large Network)')
    print('='*70)
    ...
    print(f'  FEATURES: All enhanced features (24 features)')
    print('='*70)
    print()

    # Create trainer with all enhanced features enabled and large network
    trainer = DQNTrainer(
        num_envs=args.envs,
        grid_size=10,
        ...
        use_enhanced_features=True,  # Enable all enhanced features
