"""
Train PPO with CNN (Grid-based State)

Standalone script for training PPO with 10x10x3 grid state representation.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train PPO-CNN on Snake game')
    ...
    parser.add_argument('--save-path', type=str, default='results/weights/ppo_cnn.pt', help='Path to save weights')

    args = parser.parse_args()

    print('='*70)
    print('Training PPO-CNN (Grid-based State)')
    print('='*70)
