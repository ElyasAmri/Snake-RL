"""
Train Double DQN with MLP and Flood-Fill Features

Standalone script for training Double DQN with 14-dimensional feature state representation including flood-fill.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train Double DQN-MLP with Flood-Fill on Snake game')
    ...
    parser.add_argument('--save-path', type=str, default='results/weights/double_dqn_mlp_floodfill_128x128.pt', help='Path to save weights')

    args = parser.parse_args()

    print('='*70)
    print('Training Double DQN-MLP with Flood-Fill (14-feature State)')
    print('='*70)
    ...
    # Create trainer with flood-fill and Double DQN enabled
    trainer = DQNTrainer(
        num_envs=args.envs,
        grid_size=10,
